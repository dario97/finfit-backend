...
func (receiver genericFieldsValidator) ValidateFields(s interface{}) []FieldError {
...
func (receiver genericFieldsValidator) buildFieldValidationErrors(fieldErrors []validator.FieldError) []FieldError {
	var fieldValidationErrors []FieldError
