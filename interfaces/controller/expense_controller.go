...
import (
	...
	"finfit/finfit-backend/interfaces/controller/dto"
...
func NewExpenseController(service expenseservice.ExpenseService) ExpenseController {
...
func (e expenseController) Create(context echo.Context) error {
	...
	createdExpense, err := e.expenseService.Create(expenseservice.NewCreateExpenseCommand(createExpenseRequest.Amount,
